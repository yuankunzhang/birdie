...
impl Payload for SpotPayload {}

impl<'de> Deserialize<'de> for SpotPayload {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        if helper.stream.ends_with("@aggTrade") {
            ...
            Ok(SpotPayload::PartialBookDepth(
