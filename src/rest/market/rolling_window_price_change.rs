...
pub enum RollingWindowPriceChangeResponse {
    Full(Box<RollingWindowPriceChangeFull>),
    FullVec(Box<Vec<RollingWindowPriceChangeFull>>),
    Mini(Box<RollingWindowPriceChangeMini>),
    MiniVec(Box<Vec<RollingWindowPriceChangeMini>>),
}

#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct RollingWindowPriceChangeFull {
    pub symbol: String,
...
#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct RollingWindowPriceChangeMini {
    pub symbol: String,
    pub open_price: String,
    pub high_price: String,
    pub low_price: String,
