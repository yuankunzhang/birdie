...
pub struct TestNewOrderParams {
    #[serde(flatten)]
    input: TestNewOrderInput,
    recv_window: Option<i64>,
    timestamp: i64,
}

impl TestNewOrderParams {
    pub fn new(input: TestNewOrderInput) -> Self {
        Self {
            input,
            recv_window: None,
...
pub type TestNewOrderResponse = TestNewOrderDetail;

#[derive(Debug, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct TestNewOrderDetail {
